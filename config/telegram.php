...
//                \App\Telegram\Commands\Votes\CurrentVotesCommand::class,
                ...
                \App\Telegram\Commands\Data\BookCommand::class,
                \App\Telegram\Commands\Data\UnbookCommand::class,
                \App\Telegram\Commands\Data\InvoicesCommand::class,
                \App\Telegram\Commands\Data\TransactionsCommand::class,
                \App\Telegram\Commands\PayCommand::class,
            ],
            'command_groups' => [
                'first_run' => [
                    'start',
